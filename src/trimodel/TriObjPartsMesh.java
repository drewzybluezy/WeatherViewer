 ...
 *
 */
public class TriObjPartsMesh implements TriMeshI {

	private static ArrayList<vec3> vertexBuffer = new ArrayList<vec3>();
	private static ArrayList<i3> faceBuffer = new ArrayList<i3>();
	private static ArrayList<vec3> normalBuffer = new ArrayList<vec3>();
	private static ArrayList<vec2> texBuffer = new ArrayList<vec2>();
